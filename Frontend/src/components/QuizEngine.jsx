...
import { getQuiz ,createQuizResult} from "../api/quizAPI";
...
function QuizEngine() {
  ...
  const handleSelect = (qIndex, optIndex) => {
    setAnswers((prev) => {
      ...
      const next = {
        ...prev,
        [qIndex]: { selected: optIndex, correct, skipped: false },
      };
      return next;
    });
  };
  ...
  const handleSkip = (qIndex) => {
    setAnswers((prev) => {
      ...
      return {
        ...prev,
        [qIndex]: { selected: null, correct: false, skipped: true },
      };
    });
  };
  ...
  // Send results when quiz is finished
  const sendResults = async () => {
    ...
    try {
      ...
      const response = createQuizResult({ quiz, correctAnswers, wrongAnswers });
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
            <div className="text-center mb-8">
              ...
              >
                <span className="text-white text-2xl">
                  {(quiz.technology || subject || "").toUpperCase()}
                </span>
              </div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">
                {quiz.title || `${quiz.technology} Quiz`}
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                onClick={() =>
                  navigate(`/quiz/${quiz.technology || subject}/selection`)
                }
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <div
                className={`p-4 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white`}
              >
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Quiz ID: {quiz._id}</p>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              {q.options.map((option, index) => {
                ...
                const correct =
                  isAnswered && (ans.selected === null ? false : ans.correct);
                ...
                if (isAnswered) {
                  ...
                  optionClasses +=
                    "border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 hover:shadow-sm text-gray-700 ";
                  if (isSelected)
